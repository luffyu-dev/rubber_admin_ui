    ...
    <div>
        <el-form :inline="true" class="container">
            <div class="handle-box">
                <el-input v-model="query.searchData.appName" placeholder="包名称" class="handle-input"></el-input>
        ...
        <div class="container">
            ...
            <el-table
                ...
                <el-table-column prop="packName" width="250" label="包名称" />
                ...
                <el-table-column prop="taskStatus" width="150" label="任务进度" >
                    <template slot-scope="scope">
                        <el-progress :percentage="scope.row.taskStatus  * 8"  :status="scope.row.taskStatus  * 8 >= 100 ? 'success':'warning'"/>
                    </template>
                </el-table-column>
