<script>
  ...
  export default {
    ...
    methods: {
       ...
       */
      getPageList() {
        let searchData =  this.query.searchData;
        for (var i in searchData){
            if (searchData[i] === undefined || searchData[i] === ''){
                continue;
            }
            const searchModel = {};
            searchModel.field = i;
            ...
            if (!isNaN(value)){
                ...
                searchModel.type = 'like';
            }
            searchModel.data = value;
            this.query.selectModels.push(searchModel);
        }
